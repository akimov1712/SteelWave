...
object Const {
    ...
    const val MODE_EDIT_TARGET = "mode_edit"
    const val MODE_ADD_TARGET = "mode_add"
    const val MODE_UNKNOWN = ""
    const val UNDEFINED_ID = -1
    const val START_LIMIT_USERS = 3
    const val NO_LIMIT = 10000000

//  MODE FOR MODAL CHOICE PROJECT
